...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen w-full flex items-center overflow-hidden bg-white dark:bg-[#050505] transition-colors duration-500">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.div variants={textVariants} className="space-y-2">
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-[1000] tracking-tighter leading-[0.85]">
          ...
          >
            <div className="relative w-full aspect-[4/5] max-w-[500px] overflow-hidden rounded-[2rem] lg:rounded-[3rem] border border-zinc-200 dark:border-zinc-800 group">
              {/* Fade Overlays */}
